<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MinimumCriteriaRpt.aspx.vb" Inherits="MinimumCriteriaRpt"
      ...
      <form id="form1" runat="server">
        ...
        <header id="header" class="fixed-top ">
          <div class="container d-flex align-items-center">
            ...
            <h1 class="logo mr-auto"><a href="https://irisapp-tslin.msappproxy.net/feedback_360/surveyadm_opr.aspx">360
                DEGREE FEEDBACK SURVEY</a></h1>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <a href="index.html" class="logo mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

            <nav class="nav-menu d-none d-lg-block">
              <ul>
                <li class="active"><a href="https://irisapp-tslin.msappproxy.net/feedback_360/surveyadm_opr.aspx">Home
                    (Admin)</a></li>
        ...
        <section id="hero">
          <div class="hero-container">
            ...
            <h2 class="table-responsive1">
              As we aspire to be the most valuable and respected steel company globally in the coming years, we are
              developing agile behaviours across the organization. We will measure this as an integral part of our
              Performance Management System for all the officers through a 360 degree feedback survey.
            </h2>
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-10">
                        <div style="text-align:center;margin:auto;">
                          ...
                          <asp:LinkButton ID="btn_Show" runat="server" CssClass="btn btn-primary btn-block"
                            Width="120px" type="submit" CausesValidation="false">
                            <span aria-hidden="true" class="fa fa-eye"></span> Show
                          </asp:LinkButton>&nbsp;
                          <asp:LinkButton ID="btn_download" runat="server" CssClass="btn btn-primary btn-block"
                            Width="120px" type="submit" CausesValidation="false">
                            <span aria-hidden="true" class="fa fa-download"></span> Download
                          </asp:LinkButton>&nbsp;
                          <asp:LinkButton ID="btn_download_all" runat="server" CssClass="btn btn-primary btn-block"
                            Width="120px" type="submit" CausesValidation="false">
                            <span aria-hidden="true" class="fa fa-download"></span> Download All
                          </asp:LinkButton>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row content">
                    <div class="col-md-12 col-lg-12">
                      ...
                      <asp:GridView ID="gdvMiniCriteria" runat="server" Visible="true" AutoGenerateColumns="False"
                        ...
                        CellPadding="3" GridLines="Vertical" RowStyle-CssClass="rows" OnDataBound="OnDataBound">
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="ema_empl_sgrade" HeaderText="Level"
                            SortExpression="ema_empl_sgrade" />
                          <asp:BoundField DataField="ema_eqv_level" HeaderText="Equivalent Level"
                          ...
                          <asp:BoundField DataField="ema_dept_desc" HeaderText="Department"
                            SortExpression="ema_dept_desc" />
                          <asp:BoundField DataField="ema_email_id" HeaderText="Email Id"
                            SortExpression="ema_email_id" />
                          <asp:BoundField DataField="ema_exec_head_desc" HeaderText="Executive Head"
                            SortExpression="ema_exec_head_desc" />
                          <asp:BoundField DataField="Superior_PNo" HeaderText="Superior P No."
                            SortExpression="Superior_PNo" />
                          <asp:BoundField DataField="Superior_Name" HeaderText="Superior Name"
                            SortExpression="Superior_Name" />
                          <asp:BoundField DataField="Superior_EmaiId" HeaderText="Superior Name Email ID"
                            SortExpression="Superior_EmaiId" />
                          <asp:BoundField DataField="Location" HeaderText="Location" SortExpression="Location" />
                          <asp:BoundField DataField="ema_bhr_pno" HeaderText="BUHR P No."
                            SortExpression="ema_bhr_pno" />
                          <asp:BoundField DataField="ema_bhr_name" HeaderText="BUHR Name"
                            SortExpression="ema_bhr_name" />
                          <asp:BoundField DataField="Buhr_emailId" HeaderText="BUHR Email ID"
                            SortExpression="Buhr_emailId" />
                          ...
                          <asp:BoundField DataField="Criterial" HeaderText="Overall Critera (OK/ Less)"
                            SortExpression="Criterial" />
                          <%--<asp:BoundField DataField="ema_bhr_name" HeaderText="BUHR Name"
                            SortExpression="ema_bhr_name" />--%>
                        </Columns>
                      ...
                      <asp:DataGrid ID="dgMiniCriteria" runat="server" Visible="true" AutoGenerateColumns="False"
                        CssClass="table table-striped table-hover table-bordered dataTable no-footer"
                        Font-Names="verdana" EmptyDataText="No Record Found" BorderStyle="None" BorderWidth="1px"
                        ...
                        <Columns>
                          ...
                          <asp:BoundColumn DataField="ema_empl_sgrade" HeaderText="Level"
                            SortExpression="ema_empl_sgrade" />
                          <asp:BoundColumn DataField="ema_eqv_level" HeaderText="Equivalent Level"
                            SortExpression="ema_eqv_level" />
                          <asp:BoundColumn DataField="ema_desgn_desc" HeaderText="Designation"
                            SortExpression="ema_desgn_desc" />
                          <asp:BoundColumn DataField="ema_dept_desc" HeaderText="Department"
                            SortExpression="ema_dept_desc" />
                          <asp:BoundColumn DataField="ema_email_id" HeaderText="Email Id"
                            SortExpression="ema_email_id" />
                          <asp:BoundColumn DataField="ema_exec_head_desc" HeaderText="Executive Head"
                            SortExpression="ema_exec_head_desc" />
                          <asp:BoundColumn DataField="Superior_PNo" HeaderText="Superior P No."
                            SortExpression="Superior_PNo" />
                          <asp:BoundColumn DataField="Superior_Name" HeaderText="Superior Name"
                            SortExpression="Superior_Name" />
                          <asp:BoundColumn DataField="Superior_EmaiId" HeaderText="Superior Name Email ID"
                            SortExpression="Superior_EmaiId" />
                          <asp:BoundColumn DataField="Location" HeaderText="Location" SortExpression="Location" />
                          <asp:BoundColumn DataField="ema_bhr_pno" HeaderText="BUHR P No."
                            SortExpression="ema_bhr_pno" />
                          <asp:BoundColumn DataField="ema_bhr_name" HeaderText="BUHR Name"
                            SortExpression="ema_bhr_name" />
                          <asp:BoundColumn DataField="Buhr_emailId" HeaderText="BUHR Email ID"
                            SortExpression="Buhr_emailId" />
                          ...
                          <asp:BoundColumn DataField="Criterial" HeaderText="Overall Critera (OK/ Less)"
                            SortExpression="Criterial" />
                        </Columns>
        ...
        <footer id="footer">
          <div class="container d-md-flex py-4">
            ...
            <div class="mr-md-auto text-center">
              ...
              <span>In case of any system specific queries or IT issues, please reach out to<b> IT helpdesk
                  (it_helpdesk@tatasteel.com)</b></span>
            </div>
          </div>
