<%@ Page Title="" Language="VB" MasterPageFile="~/AdminMaster.master" AutoEventWireup="false" CodeFile="RevertFeedback.aspx.vb" Inherits="RevertFeedback" %>
                    ...
                    <div class="row form-group p-1">
                        ...
                        <div class="col-md-2 text-left">
                            <div style="margin-top:7px;">
                                <asp:LinkButton runat="server" ID="btnreset" Text="Revert" class ="btn btn-warning btn-md mt-4 text-white" OnClick="btnrevert_Click"  ></asp:LinkButton>
                            </div>                            
                        </div>
                    </div>
                </div>
