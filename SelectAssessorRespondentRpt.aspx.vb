...
''' Date: 09-06-2021
''' </summary>
Partial Class SelectAssessorRespondentRpt
    ...
    Protected Sub btn_download_click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_download.Click
        'Commented & Added by TCS on 15122023, Commented Old Code & Added new Excel download code
        Try
            ExportExcel()
        Catch ex As Exception
        ...
        'Response.AddHeader("content-disposition", "attachment;filename=Selected Respondent by Assessor.xls")
        'Response.Charset = ""
        ...
        '    Response.Output.Write(sw.ToString().Replace("background-color:#E43C5C;", "background-color:blue;color:white;"))
        '    Response.Flush()
        '    Response.[End]()
        'End Using
    End Sub
    Protected Sub btn_download_all_click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_download_all.Click
        Try
            ...
            Else
                ...
                If txtCycle.Text.Trim().ToString() <> "1" Then
                    ...
                    qry1.CommandText += " from hrps.t_emp_master_feedback360 ea,t_survey_status ss where ea.ema_perno= ss.ss_asses_pno and ss.ss_status='SE' and ss.ss_del_tag='N'  and ea.ema_year=ss.ss_year and ea.ema_cycle=ss.ss_srlno  and ss.ss_year=:fy and  SS_SRLNO=:srlno and ea.EMA_COMP_CODE='1000'"
                Else
                    qry1.CommandText = " select distinct ss.ss_asses_pno Pno,ea.EMA_ENAME,ea.EMA_EQV_LEVEL,ea.EMA_DESGN_DESC Designation,ea.ema_dept_desc Department,ea.ema_email_id Email_id, "
                    qry1.CommandText += "  ea.ema_exec_head_desc Executive_Head,decode(ea.EMA_EQV_LEVEL,'I2',ea.EMA_REPORTING_TO_PNO,ea.EMA_REPORTING_TO_PNO) Superior_Pno,(select EMA_ENAME from hrps.t_emp_master_feedback360  where ema_perno=ea.EMA_REPORTING_TO_PNO and rownum=1) Superior_Name,ea.ema_bhr_pno BUHR_Pno,ea.ema_bhr_name BUHR_NAME,ss.ss_pno Respondent_Pno,"
                    qry1.CommandText += " ss.ss_name Respondent_Name,ss.ss_level Respondent_Level,ss.ss_desg Respondent_Designation,ss.ss_dept Respondent_Department,ss.ss_email Respondent_Email_Id,decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('PEER'),'Peers and Subordinates',upper('intsh'),'Internal stakeholders',upper('ropt'),'People you lead') Respondent_Category1,DECODE(ss_wfl_status,'0','Not submitted','1','Submitted','2','Manager action completed','3','Feedback submitted','9','Insufficient Exposure') Status"
                    qry1.CommandText += ",decode(ea.EMA_EQV_LEVEL,'I3',decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('PEER'),'Peer/Subordinate',upper('intsh'),'Internal stakeholders'),'TG',decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('PEER'),'Peers',upper('intsh'),'Internal stakeholders',upper('ropt'),'Subordinates'),decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('intsh'),'Peer/Subordinate/Internal stakeholders')) Respondent_Category"
                    qry1.CommandText += " from hrps.t_emp_master_feedback360 ea,t_survey_status ss where ea.ema_perno= ss.ss_asses_pno and ss.ss_status='SE' and ss.ss_del_tag='N'  and ea.ema_year=ss.ss_year and ea.ema_cycle=ss.ss_srlno  and ss.ss_year=:fy and  SS_SRLNO=:srlno and ea.EMA_COMP_CODE='1000'"
                End If
                qry1.CommandText += " and ea.ema_eqv_level in ('I1','I2','I3', 'I4','I5','I6','TG') and ea.ema_comp_code='1000' order by 1"
                ...
                '        Response.Output.Write(sw.ToString().Replace("background-color:Brown;", "background-color:blue;color:white;;font-weight:bold;"))
                '        Response.Flush()
                '        Response.[End]()
                '    End Using
                'Else
    ...
    Public Sub bindSelectAssesorGrid()
        Try
            ...
            If txtCycle.Text.Trim().ToString() <> "1" Then
                ...
                qrypending.CommandText += "  ea.ema_exec_head_desc Executive_Head,decode(ea.EMA_EQV_LEVEL,'I2',ea.EMA_REPORTING_TO_PNO,ea.EMA_REPORTING_TO_PNO) Superior_Pno,(select EMA_ENAME from hrps.t_emp_master_feedback360  where ema_perno=decode(ea.EMA_EQV_LEVEL,'I2',ea.EMA_REPORTING_TO_PNO,ea.EMA_REPORTING_TO_PNO) and rownum=1) Superior_Name,ea.ema_bhr_pno BUHR_Pno,ea.ema_bhr_name BUHR_NAME,ss.ss_pno Respondent_Pno,"
                qrypending.CommandText += " ss.ss_name Respondent_Name,ss.ss_level Respondent_Level,ss.ss_desg Respondent_Designation,ss.ss_dept Respondent_Department,ss.ss_email Respondent_Email_Id,decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('PEER'),'Peers and Subordinates',upper('intsh'),'Internal stakeholders',upper('ropt'),'People you lead') Respondent_Category1,DECODE(ss_wfl_status,'0','Not submitted','1','Submitted','2','Manager action completed','3','Feedback submitted','9','Insufficient Exposure') Status"
                qrypending.CommandText += ",decode(ea.EMA_EQV_LEVEL,'I1',decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('PEER'),'Peers',upper('intsh'),'Internal stakeholders',upper('ropt'),'Subordinates'),'I2',decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('PEER'),'Peers',upper('intsh'),'Internal stakeholders',upper('ropt'),'Subordinates'),'I3',decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('PEER'),'Peer/Subordinate',upper('intsh'),'Internal stakeholders'),'TG',decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('PEER'),'Peers',upper('intsh'),'Internal stakeholders',upper('ropt'),'Subordinates'),decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('intsh'),'Peer/Subordinate/Internal stakeholders')) Respondent_Category"
                qrypending.CommandText += " from hrps.t_emp_master_feedback360 ea,t_survey_status ss where ea.ema_perno= ss.ss_asses_pno and ea.ema_year=ss.ss_year and ea.ema_cycle=ss.ss_srlno and ss.ss_status='SE' and ss.ss_del_tag='N'   and ss.ss_year=:fy and  SS_SRLNO=:srlno and ea.ema_comp_code='1000'"
            Else
                qrypending.CommandText = " select distinct ss.ss_asses_pno Pno,ea.EMA_ENAME,ea.EMA_EQV_LEVEL,ea.EMA_DESGN_DESC Designation,ea.ema_dept_desc Department,ea.ema_email_id Email_id, "
                qrypending.CommandText += "  ea.ema_exec_head_desc Executive_Head,decode(ea.EMA_EQV_LEVEL,'I2',ea.EMA_REPORTING_TO_PNO,ea.EMA_REPORTING_TO_PNO) Superior_Pno,(select EMA_ENAME from tips.t_empl_all  where ema_perno=ea.EMA_REPORTING_TO_PNO and rownum=1) Superior_Name,ea.ema_bhr_pno BUHR_Pno,ea.ema_bhr_name BUHR_NAME,ss.ss_pno Respondent_Pno,"
                qrypending.CommandText += " ss.ss_name Respondent_Name,ss.ss_level Respondent_Level,ss.ss_desg Respondent_Designation,ss.ss_dept Respondent_Department,ss.ss_email Respondent_Email_Id,decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('PEER'),'Peers and Subordinates',upper('intsh'),'Internal stakeholders',upper('ropt'),'People you lead') Respondent_Category1,DECODE(ss_wfl_status,'0','Not submitted','1','Submitted','2','Manager action completed','3','Feedback submitted','9','Insufficient Exposure') Status"
                qrypending.CommandText += ",decode(ea.EMA_EQV_LEVEL,'I3',decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('PEER'),'Peer/Subordinate',upper('intsh'),'Internal stakeholders'),'TG',decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('PEER'),'Peers',upper('intsh'),'Internal stakeholders',upper('ropt'),'Subordinates'),decode(upper(ss.ss_categ),upper('Self'),'Self',upper('MANGR'),'Manager/Superior',upper('intsh'),'Peer/Subordinate/Internal stakeholders')) Respondent_Category"
                qrypending.CommandText += " from tips.t_empl_all ea,t_survey_status ss where ea.ema_perno= ss.ss_asses_pno and ss.ss_status='SE' and ss.ss_del_tag='N'   and ss.ss_year=:fy and  SS_SRLNO=:srlno and ea.ema_comp_code='1000'"
            End If
            ...
            End If
            qrypending.CommandText += " and ea.ema_eqv_level in ('I1','I2','I3', 'I4','I5','I6','TG') and ea.ema_comp_code='1000' order by 1"
    ...
    Public Function getDataInDt(ByVal cmd1 As OracleCommand) As DataTable
        ...
        Return dt
    End Function
    'Added by TCS on 15122023, Excel download using ClosedXML
    Protected Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Selected_Respondent_by_Assessor_" + DateTime.Now.ToString("yyyyMMddHHmmss") & ".xlsx")
