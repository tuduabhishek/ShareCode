<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Feedback_OPR.aspx.vb" Inherits="Feedback_OPR" MaintainScrollPositionOnPostback="true" %>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div id="pnl" runat="server" visible="false">
                                            ...
                                            <div class="container">
                                                <div class="section-title">
                                                    <h3>Rate  <span>
                                                        <asp:Label ID="lblRateNm" runat="server" Text="" /></span> on the following statements</span></h3>
                                                </div>
                                                <div class="row">
                                            ...
                                            <div class="row  table">
                                                ...
                                                <div class="col-md-10 col-sm-10 col-10 ">
                                                    <div style="margin-top: 15px;">
                                                        ...
                                                        <b>If
                                                        <asp:Label ID="lblRcptNm" Text="" runat="server" />
                                                            consistently displays one of the mentioned Culture Code — Change, then select the corresponding circle below the statement.</b>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12" style="margin-left: 10px%;">
                                                    <table class="table table-borderless col-12">
                                                        <tbody class="col-12">
                                                            ...
                                                            <asp:Repeater ID="questionRepeater_Change" runat="server">
                                                                <ItemTemplate>

                                                                    <tr>
                                                                        <td colspan="3" class="col-12">
                                                                            <asp:Label Text='<%# Eval("SS_QTEXT") %>' ID="questionsLabel" runat="server" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="3" class="col-12">
                                                                            <div class="option">
                                                                                <asp:RadioButtonList ID="questionOptions" runat="server" RepeatDirection="Horizontal" BorderStyle="None" Style="width: 100%" class="col-12">
                                                                                    <asp:ListItem Text="Never" Value="1"></asp:ListItem>
                                                                                    <asp:ListItem Text="Occasionally" Value="2"></asp:ListItem>
                                                                                    <asp:ListItem Text="Sometimes" Value="3"></asp:ListItem>
                                                                                    <asp:ListItem Text="Often" Value="4"></asp:ListItem>
                                                                                    <asp:ListItem Text="Mostly" Value="5"></asp:ListItem>
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                            ...
                                            <div class="row  table">
                                                ...
                                                <div class="col-md-10 col-sm-10 col-10 ">
                                                    <div style="margin-top: 15px;">
                                                        ...
                                                        <%--<b>If <asp:Label ID="lblRcptNm" Text="" runat="server" /> consistently displays either of the mentioned behaviours, then select the corresponding circle below the statement,else select the circle in the middle</b>--%>
                                                        <b>If
            <asp:Label ID="lblRcptNm2" Text="" runat="server" />
                                                            consistently displays one of the mentioned Culture Code — Connect, then select the corresponding circle below the statement.</b>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12" style="margin-left: 1px">
                                                    <table class="table table-borderless col-12">
                                                        <tbody class="col-12">
                                                            ...
                                                            <asp:Repeater ID="questionRepeater_Connect" runat="server">
                                                                <ItemTemplate>

                                                                    <tr>
                                                                        <td class="col-12" style="width: 30%">
                                                                            <asp:Label Text='<%# Eval("SS_QTEXT") %>' ID="questionsLabel" runat="server" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                            ...
                                            <div class="row  table">
                                                ...
                                                <div class="col-md-10 col-sm-10 col-10 ">
                                                    <div style="margin-top: 15px;">
                                                        ...
                                                        <%--<b>If <asp:Label ID="lblRcptNm" Text="" runat="server" /> consistently displays either of the mentioned behaviours, then select the corresponding circle below the statement,else select the circle in the middle</b>--%>
                                                        <b>If
            <asp:Label ID="lblRcptNm3" Text="" runat="server" />
                                                            consistently displays one of the mentioned Culture Code — Contribute, then select the corresponding circle below the statement.</b>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12" style="margin-left: 1px">
                                                    <table class="table table-borderless col-12">
                                                        <tbody class="col-12">
                                                            ...
                                                            <asp:Repeater ID="questionRepeater_Contribute" runat="server">
                                                                <ItemTemplate>
                                            ...
                                            <div class="row  table">
                                                ...
                                                <div class="col-md-10 col-sm-10 col-10 ">
                                                    <div style="margin-top: 15px;">
                                                        ...
                                                        <%--<b>If <asp:Label ID="lblRcptNm" Text="" runat="server" /> consistently displays either of the mentioned behaviours, then select the corresponding circle below the statement,else select the circle in the middle</b>--%>
                                                        <b>If
            <asp:Label ID="lblRcptNm4" Text="" runat="server" />
                                                            consistently displays one of the mentioned Culture Code — Care, then select the corresponding circle below the statement.</b>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12" style="margin-left: 1px">
                                                    <table class="table table-borderless col-12">
                                                        <tbody class="col-12">
                                                            ...
                                                            <asp:Repeater ID="questionRepeater_Care" runat="server">
                                                                <ItemTemplate>
                                        ...
                                        <div class="row table" runat="server" id="question1">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-lg-8 form-group">
                                                <div style="margin-top: 15px;">
                                                    <label>
                                                        Continue: Describe the behaviours that contribute to the participant's effectiveness as a leader.
                                                        <asp:Label ID="lblRecipientNm3" runat="server" Text="" Visible="false"></asp:Label><asp:Label ID="lblRecipientNm5" runat="server" Text="" Visible="false"></asp:Label>
                                        ...
                                        <br />
                                        <div class="row table" runat="server" id="question2">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-lg-8  form-group">
                                                <div style="margin-top: 15px;">
                                                    <label>
                                                        Develop: Describe the behaviours that the participant should develop to become more effective as a leader.
                                                        <asp:Label ID="lblRecipientNm4" runat="server" Text="" Visible="false"></asp:Label>
                                                        <font color="Red">*</font></label>
                                        ...
                                        <br />
<div class="row table" runat="server" id="question3">
    <div class="col-1 divB">
        <div style="margin-top: 15px;">
            <%--<span class="badge badge-pill badge-primary ml-2" style="width:50px; font-size:large; font-weight:bold;">Q2</span>--%>
        </div>
    ...
    <div class="col-md-8 col-sm-8 col-lg-8  form-group">
        <div style="margin-top: 15px;">
            <label>
                Eliminate: Describe the behaviours that the participant should eliminate to become more effective as a leader.
                <asp:Label ID="lblRecipientNm6" runat="server" Text="" Visible="false"></asp:Label>
                <font color="Red">*</font></label>
            <asp:TextBox ID="txtAns3" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="6"
                onkeypress="return setLength(event);" onkeyup="return setCharacters(event);" MaxLength="500"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtAns3"
                Display="Dynamic" ErrorMessage="Please enter 500s characters or less." ValidationGroup="vgFeedback" ForeColor="Red" SetFocusOnError="true"
                ValidationExpression="[\s\S]{1,500}"></asp:RegularExpressionValidator>
            <asp:Label ID="Label6" Text="" runat="server" />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtAns3" ValidationGroup="vgFeedback" ErrorMessage="Please provide your response" ForeColor="#E43C5C" SetFocusOnError="true"></asp:RequiredFieldValidator>
