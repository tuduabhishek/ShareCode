...
Partial Class FeedbackRpt2
    ...
    Private Sub FeedbackRpt2_Init(sender As Object, e As EventArgs) Handles Me.Init
        loadLoggedInUserIDAndDomainIntoSession()
    End Sub
    Private Sub FeedbackRpt2_Load(sender As Object, e As EventArgs) Handles Me.Load
