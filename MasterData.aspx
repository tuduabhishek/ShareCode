<%@ Page Title="" Language="VB" MasterPageFile="~/AdminMaster.master" AutoEventWireup="false"
    CodeFile="MasterData.aspx.vb" Inherits="MasterData" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="container-fluid">
                        <div class="row form-group p-2">
                            <div class="col-md-12 text-left">
                                <asp:RadioButtonList ID="rdbtnSelection" runat="server" RepeatDirection="Horizontal"
                                    CssClass="rbl" AutoPostBack="true"
                        ...
                        <asp:Panel ID="pnlIncludeEmployee" runat="server" Visible="false">
                            <div class="row form-group p-2">
                                <div class="col-md-1 text-left">
                                    ...
                                    <asp:TextBox runat="server" ID="txtYearIE" Enabled="false"
                                        CssClass="form-control" />
                                </div>
                                <div class="col-md-1 text-left">
                                    <label class="font-weight-bold">Cycle<span class="text-danger">*</span></label>
                                    <asp:TextBox runat="server" ID="txtCycleIE" Enabled="false"
                                        CssClass="form-control" />
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <label>Upload Master Employee Data</label>
                                    <asp:FileUpload ID="flUpload" runat="server" CssClass="form-control btn btn-primary"
                                        ToolTip="Select Document to Upload updated file" />
                                </div>
                                <div class="col-md-1">
                                    <div style="margin-top: 25px;">
                                        <asp:LinkButton ID="btnUpload" OnClick="btnUpload_Click" runat="server"
                                            CausesValidation="false" OnClientClick="ShowProgress();"
                                            CssClass="btn btn-primary"><i class="fa fa-upload"></i>&nbsp;Upload
                                        </asp:LinkButton>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div style="margin-top: 25px;">
                                        <asp:LinkButton ID="lbtnExcelTemplate" OnClick="lbtnExcelTemplate_Click"
                                            runat="server" CausesValidation="false" CssClass="btn btn-success"><i
                                                class="fa fa-download"></i>&nbsp;Excel Template</asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12 col-sm-12  pt-2 m-2">
                                        <div style="width: 100%; height: 300px; overflow: scroll;"
                                            ...
                                            <%-- <div
                                                ...
                                                <asp:GridView ID="grdIncludedData" runat="server"
                                                    ...
                                                    <%--<Columns>
                                                        ...
                                                        <asp:BoundField DataField="EMA_DESGN_CODE"
                                                            HeaderText="Design Code" SortExpression="EMA_DESGN_CODE" />
                                                        <asp:BoundField DataField="EMA_DESGN_DESC"
                                                            HeaderText="Design Desc" SortExpression="EMA_DESGN_DESC" />
                                                        ...
                                                        <asp:BoundField DataField="EMA_PHONE_NO" HeaderText="Phone No."
                                                            SortExpression="EMA_PHONE_NO" />
                                                        <asp:BoundField DataField="EMA_PERS_SUBAREA"
                                                            HeaderText="Sub Area" SortExpression="EMA_PERS_SUBAREA" />
                                                        <asp:BoundField DataField="EMA_PERS_SUBAREA_DESC"
                                                            HeaderText="Sub Area Desc"
                                                            SortExpression="EMA_PERS_SUBAREA_DESC" />
                                                        <asp:BoundField DataField="EMA_COMP_CODE" HeaderText="Comp Code"
                                                            SortExpression="EMA_COMP_CODE" />
                                                        <asp:BoundField DataField="EMA_REPORTING_TO_PNO"
                                                            HeaderText="Reporting P.No."
                                                            SortExpression="EMA_REPORTING_TO_PNO" />
                                                        <asp:BoundField DataField="EMA_BHR_PNO" HeaderText="BHR P.No."
                                                            SortExpression="EMA_BHR_PNO" />
                                                        <asp:BoundField DataField="EMA_BHR_NAME" HeaderText="BHR Name"
                                                            SortExpression="EMA_BHR_NAME" />
                                                        <asp:BoundField DataField="EMA_JOINING_DT"
                                                            HeaderText="Joining Date" SortExpression="EMA_JOINING_DT" />
                                                        <asp:BoundField DataField="EMA_DEPT_CODE" HeaderText="Dept Code"
                                                            SortExpression="EMA_DEPT_CODE" />
                                                        <asp:BoundField DataField="EMA_DEPT_DESC" HeaderText="Dept Desc"
                                                            SortExpression="EMA_DEPT_DESC" />
                                                        <asp:BoundField DataField="EMA_EMPL_SGRADE"
                                                            HeaderText="Sub Grade" SortExpression="EMA_EMPL_SGRADE" />
                                                        <asp:BoundField DataField="EMA_EMP_CLASS" HeaderText="Class"
                                                            SortExpression="EMA_EMP_CLASS" />
                                                        <asp:BoundField DataField="EMA_DOTTED_PNO"
                                                            HeaderText="Dotted P.No." SortExpression="EMA_DOTTED_PNO" />
                                                        <asp:BoundField DataField="EMA_PERS_EXEC_PNO"
                                                            HeaderText="Executive P.No."
                                                            SortExpression="EMA_PERS_EXEC_PNO" />
                                                        <asp:BoundField DataField="EMA_EXEC_HEAD"
                                                            HeaderText="Executive Head"
                                                            SortExpression="EMA_EXEC_HEAD" />
                                                        <asp:BoundField DataField="EMA_EXEC_HEAD_DESC"
                                                            HeaderText="Executive Head Desc"
                        ...
                        <%-- <asp:Panel ID="pnlExcludeEmployee" runat="server" Visible="false">
                            <div class="row form-group p-2">
                                <div class="col-md-1 text-left">
                                    <label class="font-weight-bold">Year<span class="text-danger">*</span></label>
                                    <asp:TextBox runat="server" ID="txtYearEE" Enabled="false"
                                        CssClass="form-control" />
                                </div>
                                <div class="col-md-1 text-left">
                                    <label class="font-weight-bold">Cycle<span class="text-danger">*</span></label>
                                    <asp:TextBox runat="server" ID="txtCycleEE" Enabled="false"
                                        CssClass="form-control" />
                                </div>
                            ...
                            <button type="button" style="display: none;" id="btnShowPopup"
                                ...
                                data-bs-target="#myModalUploadReport">
                                Launch demo modal
                            </button>
                </ContentTemplate>
                <Triggers>
