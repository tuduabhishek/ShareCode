<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptNMB_OPR.aspx.vb" Inherits="RptNMB_OPR" %>
...
<body onload="window.print();">
    <form id="form1" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-lg-7" style="text-align: left;">
                <h2>
                    <asp:Label ID="lblHeading" runat="server" Text="FY 22"></asp:Label></h2>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row" style="margin-left: 5%;">
            <div class="col-sm-12 col-md-12 col-lg-12 ">
                <h3>
                    <p>
                        These behaviours are <span class="frcolor">“Customer first”</span> – Customer Centricity, <span class="frcolor">“Take charge” </span>– Entrepreneur-ship, <span class="frcolor">“Work together” – </span>
                        Collaboration, <span class="frcolor">“Grow & Transform”</span> – People Dimension
                    </p>
                </h3>
            </div>
        </div>
        ...
        <div class="row" style="margin-left: 2%;">
            <div class="col-lg-12">
                <asp:Image ID="Image4" ImageUrl="~/Images/NMB1.JPG" runat="server" alt="" Width="1000px" />
            </div>
        </div>
        <br />
        <br />
        ...
        <div class="row" style="margin-left: 2%;">
            <div class="col-lg-12">
                <asp:Image ID="Image5" ImageUrl="~/Images/NMB2.JPG" runat="server" alt="" Width="1000px" />
            </div>
        </div>
        <br />
        <br />
        ...
        <div class="row">
            <div class="col-lg-7 col-sm-7 col-md-7" style="margin-left: 6.5%;">
                <h1>
                    <asp:Label runat="server" ID="lbloverall" Font-Size="20" Text=""></asp:Label>
                </h1>
            </div>
            <div class="col-lg-3 col-sm-3 col-md-3" style="margin-left: 6.5%;">
        ...
        <br />
        <h3>
            <table border="1" style="margin-left: 3.7%;" width="1000">
                ...
                <tr class="vendorListHeading">
                    <td>People Dimension</td>
                    <td style="text-align: center; width: 100px;">
                        <asp:Label runat="server" ID="Label12"></asp:Label><asp:Label runat="server" Visible="false" ID="lblDevSelf"></asp:Label></td>
                    <td style="text-align: center; width: 100px;">
        ...
        <div class="row" style="margin-left: 5%;">
            <div class="col-lg-2"></div>
            <div class="col-lg-5">
                <h2>Entrepreneur-ship  <%--<asp:Label runat="server" ID="lblaccountability" CssClass="bgcor"></asp:Label>--%>
        ...
        <h4>
            <table width="1000" style="margin-left: 5%;">
                ...
                <tr class="vendorListHeading">
                    <td style="text-align: left;" class="auto-style1">
                        <asp:Label runat="server" ID="Label28" CssClass="clsWrap"></asp:Label></td>
                    <td style="text-align: center; width: 100px;">
                    ...
                    <td style="text-align: center; width: 100px;">
                        <asp:Label runat="server" ID="Label35"></asp:Label></td>
                </tr>
            </table>
        </h4>
        <br />
        ...
        <h4>
            <table width="1000" style="margin-left: 5%;">
                ...
                <tr class="vendorListHeading">
                    <td style="text-align: left;" class="auto-style1">
                        <asp:Label runat="server" ID="Label83" CssClass="clsWrap"></asp:Label></td>
                    <td style="text-align: center; width: 100px;">
                        <asp:Label runat="server" ID="Label84"></asp:Label></td>
                    <td style="text-align: center; width: 100px;">
                        <asp:Label runat="server" ID="Label85"></asp:Label></td>

                    <td style="text-align: center; width: 100px;">
                        <asp:Label runat="server" ID="Label86"></asp:Label></td>
                    <td style="text-align: center; width: 100px;">
        ...
        <div class="row" style="margin-left: 5%;">
            <div class="col-lg-1"></div>
            <div class="col-lg-5">
                <h2>Customer Centricity  <%--<asp:Label runat="server" ID="lblresponse" CssClass="bgcor"></asp:Label>--%>
        ...
        <h4>
            <table width="1000" style="margin-left: 5%;">
                ...
                <tr class="vendorListHeading">
                    <td style="text-align: left;" class="auto-style1">
                        <asp:Label runat="server" ID="Label88" CssClass="clsWrap"></asp:Label></td>
                    <td style="text-align: center; width: 100px;">
        ...
        <div class="row" style="margin-left: 5%;">
            <div class="col-lg-1"></div>
            <div class="col-lg-5">
                <h2>People Dimension  <%--<asp:Label runat="server" ID="lblpeople" CssClass="bgcor"></asp:Label>--%>
        ...
        <h4>
            <table width="1000" style="margin-left: 5%;">
                ...
                <tr class="vendorListHeading">
                    <td style="text-align: left;" class="auto-style1">
                        <asp:Label runat="server" ID="Label93" CssClass="clsWrap"></asp:Label></td>
                    <td style="text-align: center; width: 100px;">
