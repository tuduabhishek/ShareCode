                ...
                If gh.Rows.Count > 0 Then
                    ...
                    Else
                        ...
                        If conHrps.State = ConnectionState.Closed Then
                            conHrps.Open()
                        End If
                        cm.CommandText = "select * from t_survey_status where upper(SS_EMAIL)=:SS_EMAIL and SS_YEAR=:SS_YEAR and SS_INTSH_OTP=:SS_INTSH_OTP and  SS_SRLNO=:SS_SRLNO"
                        cm.Parameters.Clear()
                        ...
                        If d.Rows.Count > 0 And f Then
                            ...
                            Session("statusotp") = "Y"
                            Response.Redirect("feedbackNMB_OPR.aspx?id=" & Session("otpsend"))
                        Else
