<%@ Page Title="" Language="VB" MasterPageFile="~/AdminMaster.master" AutoEventWireup="false" CodeFile="RawData.aspx.vb" Inherits="RawData" %>
                        ...
                        <div class="col-md-2 text-left">
                         ...
                         <div class="col-md-2 text-left">
                            <label class="font-weight-bold">Assessee Per. No.</label>
                             <asp:TextBox runat="server" ID="txtAssess" CssClass="form-control" MaxLength="6" placeholder="Assesse Per. No"  />
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="table-responsive">
                                <asp:GridView ID="gvself" runat="server" Visible="false" AutoGenerateColumns="False" CssClass="table table-striped table-hover table-bordered dataTable no-footer" Font-Names="verdana"
                                    EmptyDataText="No Record Found" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" RowStyle-CssClass="rows" AllowPaging="true" PageSize="20" >
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Slr. No">
                                            <ItemTemplate>
                                                <asp:Label ID="lblslrno" runat="server" Text='<%# Container.DataItemIndex + 1 %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Year">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSS_YEAR" runat="server" Text='<%# Eval("SS_YEAR")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Cycle">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCycle" runat="server" Text='<%# Eval("SS_SERIAL")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Respodent Per. No.">
                                            <ItemTemplate>
                                                <asp:Label ID="lnlRespodent" runat="server" Text='<%# Eval("SS_PNO")%>'></asp:Label>

                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Category">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblSS_CATEG" Text='<%# Eval("SS_CATEG_Desc")%>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Q. Code">
                                            <ItemTemplate>
                                                <asp:Label ID="lblQTEXT" runat="server" Text='<%# Eval("SS_QCODE")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Response">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblstats" Text='<%# Eval("SS_QOPTN")%>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Question Category">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSS_DEPT" runat="server" Text='<%# Eval("IRC_DESC")%>'></asp:Label>

                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Level">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblSS_QLEVEL" Text='<%# Eval("SS_QLEVEL")%>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Created By">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblCreatedBy" Text='<%# Eval("SS_CREATED_BY")%>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Created Dt">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblcreatedt" Text='<%# Eval("SS_CREATED_DT")%>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Modified By">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblModified" Text='<%# Eval("SS_MODIFIED_BY")%>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Modified Dt">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblModifiedDt" Text='<%# Eval("SS_MODIFIED_DT")%>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Serial No">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblSerial" Text='<%# Eval("SS_SRL_NO")%>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Flag">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblFlag" Text='<%# Eval("SS_FLAG")%>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
