<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DumpReport.aspx.vb" Inherits="DumpReport" MaintainScrollPositionOnPostback="true"  %>
      ...
      <div class="container-fluid">
        ...
        <ContentTemplate>
          <div class="panel-body">
                ...
                <asp:LinkButton ID="btn_Show" runat="server" class="btn btn-success" Width="120px" type="submit" CausesValidation="false">
                    <span aria-hidden="true" class="glyphicon glyphicon-eye-open"></span> Show
                </asp:LinkButton> 
                                                    </div>
                                <div style="margin-top:25px;margin-left:5px;float:left;">
                <asp:LinkButton ID="btn_download" runat="server" class="btn btn-primary" Width="120px" type="submit" CausesValidation="false">
                ...
                <ContentTemplate>
                    <asp:GridView ID="gdvMiniCriteria" runat="server" Visible="true" AutoGenerateColumns="False" CssClass="table table-striped table-hover table-bordered dataTable no-footer" Font-Names="verdana"
                          ...
                          <Columns>
                                            ...
                                            <asp:BoundField DataField="SS_ASSES_PNO" HeaderText="Assesee Pno." SortExpression="SS_ASSES_PNO"/>  
                                            ...
                                            <asp:BoundField DataField="SS_NAME" HeaderText="Assessor Name" SortExpression="SS_NAME"/>  
                                            <asp:BoundField DataField="SS_DESG" HeaderText="Assessor Designation" SortExpression="SS_DESG"/> 
                                            <asp:BoundField DataField="SS_DEPT" HeaderText="Assessor Department" SortExpression="SS_DEPT"/>  
                                            <asp:BoundField DataField="SS_EMAIL" HeaderText="Assessor Email" SortExpression="SS_EMAIL"/>  
                                            <asp:BoundField DataField="SS_Q1_A" HeaderText="Accountability" SortExpression="SS_Q1_A"/> 
                                            <asp:BoundField DataField="SS_Q1_B" HeaderText="Collaboration" SortExpression="SS_Q1_B"/> 
                                            <asp:BoundField DataField="SS_Q1_C" HeaderText="Responsiveness" SortExpression="SS_Q1_C"/> 
                                            <asp:BoundField DataField="SS_Q1_D" HeaderText="People Development" SortExpression="SS_Q1_D"/> 
                                            <asp:BoundField DataField="SS_Q2_A" HeaderText="Strength Q2-A" SortExpression="SS_Q2_A"/> 
                                            <asp:BoundField DataField="SS_Q2_B" HeaderText="Improvemnets Q2-B" SortExpression="SS_Q2_B"/> 
                                                        </Columns>                                
