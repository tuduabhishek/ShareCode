<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FeedbackIL1_Rpt.aspx.vb" Inherits="FeedbackIL1_Rpt"
            ...
            <%-- <link href="https://netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap-glyphicons.css"
                ...
                <script type="text/javascript">
                    ...
                    function Showmodaldiv(i) {
                        // debugger;
                        var myModal = new bootstrap.Modal(document.querySelector(i));
                        myModal.show();
                    };
                </script>
        </head>
            ...
            <form id="form1" runat="server">
                <%--<asp:UpdateProgress ID="UpdateProgress1" runat="server">
                    ...
                    <div style="margin:20px 15px; float:right;">
                        <asp:LinkButton ID="btnExport" runat="server" Text="Export" class="btn btn-warning"
                            Width="180px" OnClientClick="printDiv('pnlContainer')" CausesValidation="false">Download as
                            PDF &nbsp;
                            <span aria-hidden="true" class="fa fa-share-square-o"></span>
                        </asp:LinkButton>
                        ...
                        <div class="col-md-4">
                            <div style="margin: 20px 85px;">
                                ...
                                <div style="float:left;margin-right:5px;">
                                    <asp:TextBox ID="txt_Pno" runat="server" TabIndex="1" autocomplete="off"
                                        class="form-control" MaxLength="6" Width="120px"></asp:TextBox>
                                </div>
                                <div style="float:left;margin-right:5px;">
                                    <asp:LinkButton ID="lbtnView" runat="server" Text="Export" Font-Size="Larger"
                                        class="btn btn-primary" Width="180px" CausesValidation="false">View &nbsp;
                        ...
                        <ContentTemplate>--%>
                                ...
                                <header id="header" style="height:150px;">
                                    <div class="container d-flex align-item-left">
                                        ...
                                        <%--<h1 class="logo mr-auto"><a>360 DEGREE FEEDBACK SURVEY</a></h1>--%>
                                            ...
                                            <asp:Image ID="imgLogo" ImageUrl="Images/Logo.JPG" runat="server" alt=""
                                                height="100" width="230" class="img-fluid" />
                                ...
                                <%--======================Image section=====================--%>
                                    <section>
                                        <div class="container d-flex align-items-center">
                                            <%--<img src="Images/Feedback360.JPG" alt="Feedback360" height="800"
                                                width="1250" />--%>
                                            <asp:Image ID="bgImg" runat="server" ImageUrl="Images/Feedback360.JPG"
                                                alt="Feedback360" height="1200" width="1250" />
                                        </div>
                                        <div class="row"
                                            style="margin: 0 142px; text-align: center; font-size: 28px; font-weight: 200;">
                                            <div class="col-12">
                                    ...
                                    <%--======================Grade section=====================--%>
                                        <%--<section>--%>
                                            <div class="container" style="height:1500px;">
                                                <h2>Overall report for <asp:Label ID="lblReceiptNm1" runat="server"
                                                        Text=""></asp:Label>
                                                </h2><br /><br />
                                                ...
                                                <asp:GridView ID="gvScore" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    BorderStyle="None" BorderWidth="1px" Font-Size="20px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Q4"
                                                            HeaderText="People Development" />
                                                    </Columns>
                                            ...
                                            <%--< /section>--%>
                                                ...
                                                <%--======================Strength section=====================--%>
                                                    <%--<section>--%>
                                                        <div class="container">
                                                            <h2>Qualitative comments for <asp:Label ID="lblReceiptNm3"
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td style="padding: 6px;font-size: 20px;">
                                                                        <asp:Label ID="lblQASelf" runat="server"
                                                                            Text="" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td style="padding: 6px;font-size: 20px;">
                                                                        <asp:Label ID="lblQAOtrRespond" runat="server"
                                                                            Text="" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                            ...
                            <%--< /section>--%>
                                ...
                                <%--======================Opportunities for improvement section=====================--%>
                                    <%--<section>--%>
                                        <div class="container">
                                            <h2>Qualitative comments for <asp:Label ID="lblReceiptNm4" runat="server"
                                                    Text=""></asp:Label>
                                            </h2><br /><br />
                                            <div class="form-group">
                                        ...
                                        <%--< /section>--%>
                                            ...
                                            <footer id="footer">
                                                ...
                                                <div class="container d-md-flex py-4">
                                                    ...
                                                    <%--<div class="mr-md-auto text-center">
                                                        ...
                                                        <strong>Ms. Shruti Choudhury:
                                                        </strong>shruti.choudhury@tatasteel.com and <strong>Mr. Vikas
                                                            Kumar : </strong>vikas.kumar1@tatasteel.com
                                                </div>--%>
                                                <%-- <div class="mr-md-auto text-center text-md-left">
                                                    <div class="copyright">
                                                        &copy; Copyright <strong><span>Tata Steel</span></strong>. All
                                                        Rights Reserved
                                                    </div>
                                                    </div> --%>
                                                    </div>
                                            ...
                                            <div class="modal fade" data-bs-backdrop="static" id="MSGBOX">
