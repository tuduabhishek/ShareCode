...
Partial Class AdminMasterNMB
    ...
    Protected Sub Button7_Click(sender As Object, e As EventArgs)
        Try
            If DropDownList2.SelectedValue = "pno" Then
                ...
                Dim qry As String = ""
                qry = "select ema_perno , EMA_EQV_LEVEL from hrps.t_emp_master_feedback360 where ema_perno='" & TextBox3.Text.Trim & "' AND EMA_CYCLE='" & txtOCycle.Text.Trim().ToString & "' AND EMA_YEAR='" & txtOyear.Text.Trim().ToString & "' AND EMA_EQV_LEVEL LIKE 'NI%'"
                Dim qrycmd As New OracleCommand()
                qrycmd.CommandText = qry
                Dim gh = getRecordInDt(qrycmd, conHrps)
                ...
                Else
                    ...
                    qrycmd1.CommandText = qry
                    Dim gh1 = getRecordInDt(qrycmd1, conHrps)
                    If gh1.Rows(0)(1) = "NI3" Then
                        ovrallL3(gh1.Rows(0)(0), txtOyear.Text, txtOCycle.Text)
                    ElseIf gh1.Rows(0)(1) = "NI4" Or gh1.Rows(0)(1) = "NI5" Or gh1.Rows(0)(1) = "NI6" Then
                        ovrallL3(gh1.Rows(0)(0), txtOyear.Text, txtOCycle.Text)
                    End If
                    TextBox3.Text = ""

                End If
            ElseIf DropDownList2.SelectedValue = "NI2" Or DropDownList2.SelectedValue = "NI1" Then
                overallIL1_TO_IL6("", txtOyear.Text, txtOCycle.Text)
            ElseIf DropDownList2.SelectedValue = "NI3" Then
                overallIL1_TO_IL6("", txtOyear.Text, txtOCycle.Text)
            ElseIf DropDownList2.SelectedValue = "NI4" Or DropDownList2.SelectedValue = "NI5" Or DropDownList2.SelectedValue = "NI6" Then
                overallIL1_TO_IL6("", txtOyear.Text, txtOCycle.Text)
            Else
                ShowGenericMessageModal(CommonConstants.AlertType.info, "Please select report type")
    ...
    Protected Sub Button5_Click(sender As Object, e As EventArgs)
        Try
            If TextBox2.Text <> "" Then
                ...
                Dim qry As String = ""
                qry = "select ema_perno , decode(EMA_EQV_LEVEL,'NI1','I1','NI2','I2','NI3','I3','NI4','I4','NI5','I5','NI6','I6') EMA_EQV_LEVEL1,EMA_EQV_LEVEL from hrps.t_emp_master_feedback360 where ema_perno='" & TextBox2.Text.Trim & "' AND EMA_CYCLE='" & txtFcycle.Text.Trim().ToString & "' AND EMA_YEAR='" & txtFyear.Text.Trim().ToString & "'"
                Dim qrycmd As New OracleCommand()
                qrycmd.CommandText = qry
                Dim gh = getRecordInDt(qrycmd, conHrps)
                If gh.Rows.Count > 0 Then
                    ...
                    If gh.Rows(0)(2) = "NI3" Or gh.Rows(0)(2) = "NI2" Or gh.Rows(0)(2) = "NI1" Then
                        If checkcateg(TextBox2.Text, gh.Rows(0)(1)) Then
                            If Not f1 Is Nothing And f1.Rows.Count > 0 Then
                                Response.Redirect("FeedbackSurveyRptNMB_OPR.aspx?pno=" & SimpleCrypt(TextBox2.Text) & "&yr=" & SimpleCrypt(txtFyear.Text) & "&cyc=" & SimpleCrypt(txtFcycle.Text))
                            Else
                        ...
                        End If
                    ElseIf gh.Rows(0)(2) = "NI4" Or gh.Rows(0)(2) = "NI5" Or gh.Rows(0)(2) = "NI6" Then
                        If checkcateg(TextBox2.Text, gh.Rows(0)(1)) Then
                            If Not f1 Is Nothing And f1.Rows.Count > 0 Then
                                'Commented and added by TCS on 06092022 (New Report Download for I4,I5,I6)
                                Response.Redirect("RptNMB_OPR.aspx?pno=" & SimpleCrypt(TextBox2.Text) & "&yr=" & SimpleCrypt(txtFyear.Text) & "&cyc=" & SimpleCrypt(txtFcycle.Text))
    ...
    Public Sub overallIL1_TO_IL6(pno As String, yr As String, cyc As String)
        Try
            If pno = "" Then
                ...
                qry += "Select SS.ss_asses_pno from hrps.t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno= se.ema_cycle and ss.ss_wfl_status ='3' and ss.ss_year='" & yr.ToString & "' AND ss.ss_srlno='" & cyc.ToString & "' and ss_categ='MANGR' AND se.ema_comp_code='1000' and se.ema_eqv_level like 'NI%' Group by ss.ss_asses_pno,se.ema_eqv_level HAVING count(*)>=(select substr(ic.irc_desc,1,1) from hrps.t_ir_codes ic where decode(ic.irc_type,'" & yrCyc & "I1','NI1','" & yrCyc & "I2','NI2','" & yrCyc & "I3','NI3','" & yrCyc & "I4','NI4','" & yrCyc & "I5','NI5','" & yrCyc & "I6','NI6')=se.ema_eqv_level and ic.irc_valid_tag='A' and ic.irc_code='MANGR')"

                If DropDownList2.SelectedValue = "NI1" Then
                    qry += "INTERSECT Select SS.ss_asses_pno from hrps.t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno= se.ema_cycle and ss.ss_wfl_status ='3' and ss.ss_year='" & yr.ToString & "' AND ss.ss_srlno='" & cyc.ToString & "' and ss_categ='PEER' AND se.ema_comp_code='1000' and se.ema_eqv_level like 'NI%' Group by ss.ss_asses_pno,se.ema_eqv_level HAVING count(*)>=(select substr(ic.irc_desc,1,1) from hrps.t_ir_codes ic where ic.irc_type='" & yrCyc & "I1' and ic.irc_valid_tag='A' and ic.irc_code='PEER' and se.ema_eqv_level='NI1')"
                    qry += "INTERSECT Select SS.ss_asses_pno from hrps.t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno= se.ema_cycle and ss.ss_wfl_status ='3' and ss.ss_year='" & yr.ToString & "' AND ss.ss_srlno='" & cyc.ToString & "' and ss_categ='ROPT' AND se.ema_comp_code='1000' and se.ema_eqv_level like 'NI%' Group by ss.ss_asses_pno,se.ema_eqv_level HAVING count(*)>=(select substr(ic.irc_desc,1,1) from hrps.t_ir_codes ic where ic.irc_type='" & yrCyc & "I1' and ic.irc_valid_tag='A' and ic.irc_code='ROPT' and se.ema_eqv_level='NI1')"
                End If

                If DropDownList2.SelectedValue = "NI2" Then
                    qry += "INTERSECT Select SS.ss_asses_pno from hrps.t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno= se.ema_cycle and ss.ss_wfl_status ='3' and ss.ss_year='" & yr.ToString & "' AND ss.ss_srlno='" & cyc.ToString & "' and ss_categ='PEER' AND se.ema_comp_code='1000' and se.ema_eqv_level like 'NI%' Group by ss.ss_asses_pno,se.ema_eqv_level HAVING count(*)>=(select substr(ic.irc_desc,1,1) from hrps.t_ir_codes ic where ic.irc_type='" & yrCyc & "I2' and ic.irc_valid_tag='A' and ic.irc_code='PEER' and se.ema_eqv_level='NI2')"
                    qry += "INTERSECT Select SS.ss_asses_pno from hrps.t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno= se.ema_cycle and ss.ss_wfl_status ='3' and ss.ss_year='" & yr.ToString & "' AND ss.ss_srlno='" & cyc.ToString & "' and ss_categ='ROPT' AND se.ema_comp_code='1000' and se.ema_eqv_level like 'NI%' Group by ss.ss_asses_pno,se.ema_eqv_level HAVING count(*)>=(select substr(ic.irc_desc,1,1) from hrps.t_ir_codes ic where ic.irc_type='" & yrCyc & "I2' and ic.irc_valid_tag='A' and ic.irc_code='ROPT' and se.ema_eqv_level='NI2')"
                    qry += "INTERSECT Select SS.ss_asses_pno from hrps.t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno= se.ema_cycle and ss.ss_wfl_status ='3' and ss.ss_year='" & yr.ToString & "' AND ss.ss_srlno='" & cyc.ToString & "' and ss_categ='INTSH' AND se.ema_comp_code='1000' and se.ema_eqv_level like 'NI%' Group by ss.ss_asses_pno,se.ema_eqv_level HAVING count(*)>=(select substr(ic.irc_desc,1,1) from hrps.t_ir_codes ic where ic.irc_type='" & yrCyc & "I2' and ic.irc_valid_tag='A' and ic.irc_code='INTSH' and se.ema_eqv_level='NI2')"
                End If

                If DropDownList2.SelectedValue = "NI3" Then
                    qry += "INTERSECT Select SS.ss_asses_pno from hrps.t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno= se.ema_cycle and ss.ss_wfl_status ='3' and ss.ss_year='" & yr.ToString & "' AND ss.ss_srlno='" & cyc.ToString & "' and ss_categ='PEER' AND se.ema_comp_code='1000' and se.ema_eqv_level like 'NI%' Group by ss.ss_asses_pno,se.ema_eqv_level HAVING count(*)>=(select substr(ic.irc_desc,1,1) from hrps.t_ir_codes ic where ic.irc_type='" & yrCyc & "I3' and ic.irc_valid_tag='A' and ic.irc_code='PEER' and se.ema_eqv_level='NI3')"

                    qry += "INTERSECT Select SS.ss_asses_pno from hrps.t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno= se.ema_cycle and ss.ss_wfl_status ='3' and ss.ss_year='" & yr.ToString & "' AND ss.ss_srlno='" & cyc.ToString & "' and ss_categ='INTSH' AND se.ema_comp_code='1000' and se.ema_eqv_level like 'NI%' Group by ss.ss_asses_pno,se.ema_eqv_level HAVING count(*)>=(select substr(ic.irc_desc,1,1) from hrps.t_ir_codes ic where ic.irc_type='" & yrCyc & "I3' and ic.irc_valid_tag='A' and ic.irc_code='INTSH' and se.ema_eqv_level='NI3')"
                End If

                If DropDownList2.SelectedValue = "NI4" Then
                    qry += "INTERSECT Select SS.ss_asses_pno from hrps.t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno= se.ema_cycle and ss.ss_wfl_status ='3' and ss.ss_year='" & yr.ToString & "' AND ss.ss_srlno='" & cyc.ToString & "' and ss_categ='INTSH' AND se.ema_comp_code='1000' and se.ema_eqv_level like 'NI%' Group by ss.ss_asses_pno,se.ema_eqv_level HAVING count(*)>=(select substr(ic.irc_desc,1,1) from hrps.t_ir_codes ic where ic.irc_type='" & yrCyc & "I4' and ic.irc_valid_tag='A' and ic.irc_code='INTSH' and se.ema_eqv_level ='NI4')"
                End If

                If DropDownList2.SelectedValue = "NI5" Then
                    qry += "INTERSECT Select SS.ss_asses_pno from hrps.t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno= se.ema_cycle and ss.ss_wfl_status ='3' and ss.ss_year='" & yr.ToString & "' AND ss.ss_srlno='" & cyc.ToString & "' and ss_categ='INTSH' AND se.ema_comp_code='1000' and se.ema_eqv_level like 'NI%' Group by ss.ss_asses_pno,se.ema_eqv_level HAVING count(*)>=(select substr(ic.irc_desc,1,1) from hrps.t_ir_codes ic where ic.irc_type='" & yrCyc & "I5' and ic.irc_valid_tag='A' and ic.irc_code='INTSH' and se.ema_eqv_level ='NI5')"
                End If

                If DropDownList2.SelectedValue = "NI6" Then
                    qry += "INTERSECT Select SS.ss_asses_pno from hrps.t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno= se.ema_cycle and ss.ss_wfl_status ='3' and ss.ss_year='" & yr.ToString & "' AND ss.ss_srlno='" & cyc.ToString & "' and ss_categ='INTSH' AND se.ema_comp_code='1000' and se.ema_eqv_level like 'NI%' Group by ss.ss_asses_pno,se.ema_eqv_level HAVING count(*)>=(select substr(ic.irc_desc,1,1) from hrps.t_ir_codes ic where ic.irc_type='" & yrCyc & "I6' and ic.irc_valid_tag='A' and ic.irc_code='INTSH' and se.ema_eqv_level ='NI6')"
                End If
    ...
    Public Sub ovrallL3(pno As String, yr As String, cyc As String)
        Try
            If pno = "" Then
                Dim qry As String = ""
                qry = "Select ss_asses_pno from t_survey_status ss ,hrps.t_emp_master_feedback360 se where  ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno = se.ema_cycle and ss_wfl_status ='3' and ss_year='" & yr.ToString() & "' AND SS_SRLNO='" & cyc.ToString & "' and ss_status = 'SE' and ss_del_tag = 'N' and upper(ss_categ) NOT in ('SELF') and upper(ss_categ)='MANGR' And ss_app_tag = 'AP' and se.EMA_EQV_LEVEL  in ('NI1','NI2','NI3')  Group by ss_asses_pno,ss_categ HAVING count(*)>=1 INTERSECT Select ss_asses_pno from t_survey_status ss ,hrps.t_emp_master_feedback360 se where ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno = se.ema_cycle and ss_wfl_status ='3' and ss_year='" & yr.ToString() & "' AND SS_SRLNO='" & cyc.ToString & "' and ss_status = 'SE' and ss_del_tag = 'N' and upper(ss_categ) NOT in ('SELF') and upper(ss_categ)='INTSH' And ss_app_tag = 'AP' and se.EMA_EQV_LEVEL in ('NI1','NI2','NI3')  Group by ss_asses_pno,ss_categ HAVING count(*)>=3 INTERSECT Select ss_asses_pno from t_survey_status ss ,hrps.t_emp_master_feedback360 se where ss.ss_asses_pno=se.ema_perno and ss.ss_year=se.ema_year and ss.ss_srlno = se.ema_cycle and ss_wfl_status ='3' and ss_year='" & yr.ToString() & "'AND SS_SRLNO='" & cyc.ToString & "' and ss_status = 'SE' and ss_del_tag = 'N' and upper(ss_categ) NOT in ('SELF') and upper(ss_categ)='PEER' And ss_app_tag = 'AP' and se.EMA_EQV_LEVEL in ('NI1','NI2','NI3')  Group by ss_asses_pno,ss_categ HAVING count(*)>=3 order by ss_asses_pno"
