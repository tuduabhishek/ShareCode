...
Public Class ReportIL1toIL3
    ...
    Public Sub GenerateReport(ByVal perNo As String, ByVal yr As String, ByVal cycle As String)
        ...
        Using ms As New MemoryStream()
            ...
            If lvl = "I3" Then
                tablefd1.AddCell(GetCellForBorderedTable(New Phrase("Peers & Subordinates", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            Else
                tablefd1.AddCell(GetCellForBorderedTable(New Phrase("Peer", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            End If
            If lvl = "I1" Or lvl = "I2" Then
                tablefd1.AddCell(GetCellForBorderedTable(New Phrase("Subordinate", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            End If
            If lvl <> "I1" Then
            ...
            For i = 0 To accountbltyDt.Rows.Count - 1
                ...
                tablefd1.AddCell(GetCellForBorderedTable(New Phrase(Convert.ToString(accountbltyDt.Rows(i)("PEER")), FontFactory.GetFont("calibri", 10)), Element.ALIGN_CENTER, myColor))
                If lvl = "I2" Or lvl = "I1" Then
            ...
            If lvl = "I3" Then
                tablefd2.AddCell(GetCellForBorderedTable(New Phrase("Peers & Subordinates", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            Else
                tablefd2.AddCell(GetCellForBorderedTable(New Phrase("Peer", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            End If
            If lvl = "I2" Or lvl = "I1" Then
                tablefd2.AddCell(GetCellForBorderedTable(New Phrase("Subordinate", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            End If
            If lvl <> "I1" Then
            ...
            For i = 0 To collabrDt.Rows.Count - 1
                ...
                tablefd2.AddCell(GetCellForBorderedTable(New Phrase(Convert.ToString(collabrDt.Rows(i)("PEER")), FontFactory.GetFont("calibri", 10)), Element.ALIGN_CENTER, myColor))
                If lvl = "I2" Or lvl = "I1" Then
            ...
            If lvl = "I3" Then
                tablefd3.AddCell(GetCellForBorderedTable(New Phrase("Peers & Subordinates", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            Else
                tablefd3.AddCell(GetCellForBorderedTable(New Phrase("Peer", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            End If
            If lvl = "I2" Or lvl = "I1" Then
                tablefd3.AddCell(GetCellForBorderedTable(New Phrase("Subordinate", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            End If
            If lvl <> "I1" Then
            ...
            For i = 0 To responsiveDt.Rows.Count - 1
                ...
                tablefd3.AddCell(GetCellForBorderedTable(New Phrase(Convert.ToString(responsiveDt.Rows(i)("PEER")), FontFactory.GetFont("calibri", 10)), Element.ALIGN_CENTER, myColor))
                If lvl = "I2" Or lvl = "I1" Then
            ...
            If lvl = "I3" Then
                tablefd4.AddCell(GetCellForBorderedTable(New Phrase("Peers & Subordinates", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            Else
                tablefd4.AddCell(GetCellForBorderedTable(New Phrase("Peer", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            End If
            If lvl = "I2" Or lvl = "I1" Then
                tablefd4.AddCell(GetCellForBorderedTable(New Phrase("Subordinate", FontFactory.GetFont("calibri", 10, iTextSharp.text.Font.BOLD, headerFontColor)), Element.ALIGN_CENTER, headerColor))
            End If
            If lvl <> "I1" Then
            ...
            For i = 0 To teamBuilDt.Rows.Count - 1
                ...
                tablefd4.AddCell(GetCellForBorderedTable(New Phrase(Convert.ToString(teamBuilDt.Rows(i)("PEER")), FontFactory.GetFont("calibri", 10)), Element.ALIGN_CENTER, myColor))
                If lvl = "I2" Or lvl = "I1" Then
            ...
            If lvl = "I1" Then
                Dim items As String() = {"•   There are three categories of respondent: Manager, Peers and Subordinates.",
                ...
                Next
            ElseIf lvl = "I2" Then
                Dim items As String() = {"•   There are four categories of respondent: : Manager, Peers, Subordinates and Internal Stakeholder",
                                 "•   Each category of respondent has equal weightage.",
                                 "•   The overall behavior score is an outcome of scoring done by different respondent categories on practices."}
                For i As Integer = 0 To items.Length - 1
                    ph2Page10.Add(New Chunk(items(i).ToString() & vbLf, FontFactory.GetFont("calibri", 10, 0)))
            ...
            If lvl = "I1" Then
                Dim items1 As String() = {"•   Manager Score (M) (1 respondent) - A",
                                 "•   Average Peer Score (P) (10 respondents) - G",
                                 "•   Average Sub-ordinates Score (S) (10 respondents) - G",
                                  "•   Overall Score (O)- A"}
            ...
            If lvl = "I1" Then
                cell = ImageCell("EX1IL1.jpg", 70.0F, PdfPCell.ALIGN_CENTER)
            ElseIf lvl = "I2" Then
                cell = ImageCell("EX1IL2.jpg", 70.0F, PdfPCell.ALIGN_CENTER)
            ElseIf lvl = "I3" Then
            ...
            If lvl = "I1" Then
                cell = ImageCell("EX2IL1.jpg", 70.0F, PdfPCell.ALIGN_CENTER)
            ElseIf lvl = "I2" Then
                cell = ImageCell("EX2IL2.jpg", 70.0F, PdfPCell.ALIGN_CENTER)
            ElseIf lvl = "I3" Then
    ...
    Public Function AccountibilityData(ByVal perNo As String, ByVal year As String, ByVal cycle As String, ByVal allResponseData As DataTable, ByVal level As String) As DataTable
        ...
        If allResponseData.Rows.Count > 0 Then
            ...
            'Accountibility(Peer)
            Dim drAccPeer() As DataRow = allResponseData.Select("ss_desc='Accountability' and ss_categ='PEER'")
    ...
    Public Function ResponsivenessData(ByVal perNo As String, ByVal year As String, ByVal cycle As String, ByVal allResponseData As DataTable, ByVal level As String) As DataTable
        ...
        If allResponseData.Rows.Count > 0 Then
            ...
            'Responsiveness(Peer)
            Dim drResPeer() As DataRow = allResponseData.Select("ss_desc='Responsiveness' and ss_categ='PEER'")
            ...
            If dtResPeer.Rows.Count > 0 Then
                For i = 0 To dtResPeer.Rows.Count - 1
                    dtResponsiveness.Rows(i)("PEER") = Convert.ToString(dtResPeer.Rows(i)("AC"))
                Next
            End If
    ...
    Public Function CollabarationData(ByVal perNo As String, ByVal year As String, ByVal cycle As String, ByVal allResponseData As DataTable, ByVal level As String) As DataTable
        ...
        dtCollabaration.Columns.Add("PEER", GetType(String))
        If level <> "I1" Then
        ...
        If allResponseData.Rows.Count > 0 Then
            ...
            'Collaboration(Peer)
            Dim drCollPeer() As DataRow = allResponseData.Select("ss_desc='Collaboration' and ss_categ='PEER'")
            ...
            If dtCollPeer.Rows.Count > 0 Then
                For i = 0 To dtCollPeer.Rows.Count - 1
                    dtCollabaration.Rows(i)("PEER") = Convert.ToString(dtCollPeer.Rows(i)("AC"))
                Next
            End If
    ...
    Public Function TeamData(ByVal perNo As String, ByVal year As String, ByVal cycle As String, ByVal allResponseData As DataTable, ByVal level As String) As DataTable
        ...
        dtTeam.Columns.Add("PEER", GetType(String))
        If level <> "I1" Then
        ...
        If allResponseData.Rows.Count > 0 Then
            ...
            'Team(Peer)
            Dim drTeamPeer() As DataRow = allResponseData.Select("ss_desc='People Development' and ss_categ='PEER'")
            ...
            If dtTeamPeer.Rows.Count > 0 Then
                For i = 0 To dtTeamPeer.Rows.Count - 1
                    dtTeam.Rows(i)("PEER") = Convert.ToString(dtTeamPeer.Rows(i)("AC"))
                Next
            End If
