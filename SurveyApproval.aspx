<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SurveyApproval.aspx.vb" Inherits="SurveyApproval"
                    ...
                    <div class="container d-flex align-items-center">
                        ...
                        <nav class="nav-menu d-none d-lg-block">
                            <ul>
                                ...
                                <li><a href="Images/User_manual_360 DEGREE Survey Approval.pdf" target="_blank">Help</a>
                                </li>
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="table-responsive">
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                                            <ContentTemplate>
                                                <asp:GridView ID="gvself" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <div class="row content">
                                        ...
                                        <div class="col-lg-3">
                                            <asp:Button runat="server" ID="btnrej" Text="Send Back To Officer"
                                                class="btn-learn-more" Visible="false" OnClick="btnrej_Click">
                                            </asp:Button>
                                        </div>
                                        <div class="col-lg-2">
                                            <asp:Button runat="server" ID="lbOrg" Text="Approve" class="btn-learn-more"
                                                OnClick="lbOrg_Click" Visible="false"></asp:Button>
                                        </div>
                                    </div>
                        </div>
                        </ContentTemplate>
