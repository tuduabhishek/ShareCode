<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SurveyAdm.aspx.vb" Inherits="SurveyAdm"
                    ...
                    <div class="container d-flex align-items-center">
                        ...
                        <nav class="nav-menu d-none d-lg-block">
                            <ul>
                                ...
                                <li>
                                    <a href="" data-bs-toggle="modal" data-bs-target="#myModal">Return </a>

                                </li>
                                <li>
                                    <a href="" data-bs-toggle="modal" data-bs-target="#myModal1">Revert Feedback</a>
                                </li>
                                <li>
                ...
                <section id="hero">
                    <div class="hero-container">
                        ...
                        <h2 class="table-responsive1">As we aspire to be the most valuable and respected steel company
                            globally in the next 5-10 years, we are developing agile behaviours in our top leadership -
                            accountability, responsiveness, collaboration and people development. We will measure this
                            as an integral part of our Performance Management System for IL2s through a 360 degree
                            feedback survey.</h2>
                                    ...
                                    <div class="table-responsive">
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                                            <ContentTemplate>
                                                <asp:GridView ID="gvself" runat="server" Visible="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Click to View Details">
                                                            <ItemTemplate>
                                                                <asp:LinkButton runat="server" ID="lbpendingapproval"
                                                                    Text="" OnClick="lbpendingapproval_Click"
                                                ...
                                                <asp:GridView ID="gvoverall" runat="server" AutoGenerateColumns="False"
                                                    CssClass="table table-striped table-hover table-bordered dataTable no-footer"
                                                    Font-Names="verdana" EmptyDataText="No Record Found"
                                                    BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                                    GridLines="Vertical" RowStyle-CssClass="rows">
                                                        ...
                                                        <asp:TemplateField HeaderText="Level">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblfmail1" runat="server"
                                                                    Text='<%# Eval("EMA_EMPL_SGRADE")%>'></asp:Label>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <asp:Label runat="server" ID="lbls" CssClass="label"
                                                        ...
                                                        <asp:TemplateField HeaderText="P.no">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblapno" runat="server"
                                                                    Text='<%# Eval("SS_ASSES_PNO")%>' Visible="false">
                                                                </asp:Label>
                                    ...
                                    <div class="row content">
                                        ...
                                        <div class="col-lg-1">
                                            <asp:Button runat="server" ID="btnsubmit" Text="Submit"
                                                class="btn-learn-more" OnClick="btnsubmit_Click" Visible="false">
                                            </asp:Button>
                                        </div>
                                    </div>
                                </ContentTemplate>
