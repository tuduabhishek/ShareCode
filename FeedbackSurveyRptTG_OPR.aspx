<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FeedbackSurveyRptTG_OPR.aspx.vb" Inherits="FeedbackSurveyRptTG_OPR" %>
            ...
            <table border="1" style="margin-left: 3.4%;" width="1000">
                ...
                <tr class="vendorListHeading" style="font-weight: bold;">
                    ...
                    <td style="text-align: center; width: 110px;" id="tdOvaPeer" runat="server">
                        <asp:Label runat="server" ID="lblOverallPeerHeading" Text="Subordinates"></asp:Label></td>
                    <td style="text-align: center; width: 100px;" id="tdOvaSub" runat="server" visible="false">Subordinate</td>
                    <td style="text-align: center; width: 100px;" id="tdOvaIntsh" runat="server">External Stakeholder</td>
        ...
        <h4>
            <table width="1000" style="margin-left: 5%;">
                ...
                <tr class="vendorListHeading" style="font-weight: bold;">
                    ...
                    <td style="text-align: center; width: 100px;">Manager</td>
                    <td style="text-align: center; width: 100px;">
                        <asp:Label runat="server" ID="hdAccPeer" Text="Subordinates"></asp:Label></td>
                    ...
                    <td style="text-align: center; width: 100px;">External Stakeholder</td>
                    <td style="text-align: center; width: 100px;">Overall*</td>
                </tr>
                <tr class="trbg">
        ...
        <h4>
            <table width="1000" style="margin-left: 5%;">
                ...
                <tr class="vendorListHeading" style="font-weight: bold;">
                    ...
                    <td style="text-align: center; width: 100px;">Self</td>
                    <td style="text-align: center; width: 100px;">Manager</td>
                    <td style="text-align: center; width: 100px;">Subordinates</td>
                    <td style="text-align: center; width: 100px;">External Stakeholder</td>
                    <td style="text-align: center; width: 100px;">Overall*</td>
                </tr>
                <tr class="trbg">
