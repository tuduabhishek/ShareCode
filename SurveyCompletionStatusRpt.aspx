<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SurveyCompletionStatusRpt.aspx.vb"
    Inherits="SurveyCompletionStatusRpt" MaintainScrollPositionOnPostback="true" %>
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="gdvselectAssesor" runat="server"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="SS_ID" HeaderText="Unique Id"
                                                                    SortExpression="SS_ID" />
                                                            </Columns>
                                                        ...
                                                        <asp:DataGrid ID="dgMiniCriteria" runat="server" Visible="true"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundColumn DataField="Status" HeaderText="Status"
                                                                    SortExpression="Status" />
                                                                <asp:BoundColumn DataField="SS_ID"
                                                                    HeaderText="Unique Id" SortExpression="SS_ID" />
                                                            </Columns>
