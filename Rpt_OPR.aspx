<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RPT_OPR.aspx.vb" Inherits="RPT_OPR" %>
...
<body onload="window.print();">
    ...
    <div class="col-lg-2">
       ...
       <br />
        ...
        <br />
         <div class="row">
             <div class ="col-lg-7 col-sm-7 col-md-7" style="margin-left:6.5%;">
                <h1> <asp:Label runat ="server" ID ="lbloverall" Font-Size="20" Text=""></asp:Label> </h1>
            </div>
            <div class ="col-lg-3 col-sm-3 col-md-3" style="margin-left:6.5%;">
       ...
       <h3> <table border="1" style="margin-left:3.7%;" width="1000">
        ...
        <br />
         ...
         <div class="row">
             <div class ="col-lg-7 col-sm-7 col-md-7" style="margin-left:6.5%;">
                <h1> <asp:Label runat ="server" ID ="lblall" Text="" Font-Size="20"></asp:Label> </h1>
            </div>
            <div class ="col-lg-3 col-sm-3 col-md-3" style="margin-left:6.5%;">
  ...
  <br />
        ...
        <br />
         <div class="row">
             <div class ="col-lg-7 col-sm-7 col-md-7" style="margin-left:6.5%;">
                <h1> <asp:Label runat ="server" ID ="Label119" Text="" Font-Size ="20"></asp:Label> </h1>
            </div>
            <div class ="col-lg-3 col-sm-3 col-md-3" style="margin-left:6.5%;">
       ...
       <br />
        ...
        <br />
         <div class="row">
             <div class ="col-lg-7 col-sm-7 col-md-7" style="margin-left:6.5%;">
                <h1> <asp:Label runat ="server" ID ="lblnmm" Text=""  Font-Size="20"></asp:Label> </h1>
            </div>
            <div class ="col-lg-3 col-sm-3 col-md-3" style="margin-left:6.5%;">
       ...
       <p style="page-break-before:always;"></p> 
        ...
        <div class="row">
             <div class ="col-lg-7 col-sm-7 col-md-7" style="margin-left:6.5%;">
                <h1> <asp:Label runat ="server" ID ="Label66" Text="" Font-Size="20"></asp:Label> </h1>
            </div>
            <div class ="col-lg-3 col-sm-3 col-md-3" style="margin-left:6.5%;">
