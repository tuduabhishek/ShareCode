<%@ Page Title="" Language="VB" MasterPageFile="~/AdminMaster.master" AutoEventWireup="false" CodeFile="ReturnToApprover.aspx.vb" Inherits="ReturnToApprover" %>
                ...
                <div class="panel-body">
                    <div class="row form-group p-1">
                        ...
                        <div class="col-md-2 text-left">
                            ...
                            <asp:TextBox runat="server" ID="txtperno" CssClass="form-control" MaxLength="6" placeholder="Assesee P.No"></asp:TextBox>
                        </div>
                        <div class="col-md-2 text-left">
                            <div style="margin-top:7px;">
                                <asp:LinkButton runat="server" ID="btnreset" Text="Return" class ="btn btn-warning btn-md mt-4 text-white" OnClick="btn_revertapp_click"  ></asp:LinkButton>
                            </div>                            
                        </div>
                    </div>
                </div>
