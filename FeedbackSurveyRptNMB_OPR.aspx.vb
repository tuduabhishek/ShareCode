...
Partial Class FeedbackSurveyRptNMB_OPR
    ...
    Private Sub Rpt_OPR_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        dc.CommandText = "select ema_perno, ema_ename, ema_desgn_desc,decode(EMA_EQV_LEVEL,'NI1','I1','NI2','I2','NI3','I3') EMA_EQV_LEVEL from hrps.t_emp_master_feedback360  where ema_perno=:pno and ema_year=:ema_year and ema_cycle=:ema_srlno and EMA_EQV_LEVEL like 'NI%'"
