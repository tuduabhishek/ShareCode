<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FeedbackSurveyRptNMB_OPR.aspx.vb" Inherits="FeedbackSurveyRptNMB_OPR" %>
...
<body onload="window.print();">
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-8">
                <asp:Image ID="Image4" ImageUrl="~/Images/NMB1.JPG" runat="server" alt="" />
            </div>
        </div>
        <br />
        <br />
        ...
        <div class="row">
            <div class="col-lg-8">
                <asp:Image ID="Image5" ImageUrl="~/Images/NMB2.JPG" runat="server" alt="" />
            </div>
        </div>
        <br />
        <br />
        ...
        <h3>
            <table border="1" style="margin-left: 3.4%;" width="1000">
                ...
                <tr class="trbg">
                    <td style="border-left: 0px dotted transparent;">Entrepreneur-ship</td>
