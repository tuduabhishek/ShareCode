<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EmployeeIndividualScore.aspx.vb"
    Inherits="EmployeeIndividualScore" MaintainScrollPositionOnPostback="true" %>
        ...
        <main id="main">
            ...
            <section id="about" class="about">
                <div class="container-fluid">
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <h1>Employee Individual Score</h1>
                        </div>
                    </div>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                                                <ContentTemplate>
                                                    <asp:GridView ID="gdvselectAssesor" runat="server" Visible="true"
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField DataField="p_no" HeaderText="P.No" SortExpression="p_no" />
                                                            <asp:BoundField DataField="name" HeaderText="Name" SortExpression="name" />
                                                            <asp:BoundField DataField="designation" HeaderText="Designation"
                                                                SortExpression="designation" />
                                                            <asp:BoundField DataField="behavior" HeaderText="Behavior"
                                                                SortExpression="behavior" />
                                                            <asp:BoundField DataField="practice" HeaderText="Practice"
                                                                SortExpression="practice" />
                                                            <asp:BoundField DataField="self_score" HeaderText="Self Score"
                                                                SortExpression="self_score" DataFormatString="{0:N2}" HtmlEncode="false" />
                                                            <asp:BoundField DataField="manager_score" HeaderText="Manager Score"
                                                                SortExpression="manager_score" DataFormatString="{0:N2}" HtmlEncode="false" />
                                                            <asp:BoundField DataField="peer_score" HeaderText="Peer Score"
                                                                SortExpression="peer_score" DataFormatString="{0:N2}" HtmlEncode="false" />
                                                            <asp:BoundField DataField="subordinate_score" HeaderText="Subordinate Score"
                                                                SortExpression="subordinate_score" DataFormatString="{0:N2}" HtmlEncode="false" />
                                                            <asp:BoundField DataField="int_stakeholder_score" HeaderText="Int. Stakeholder Score"
                                                                SortExpression="int_stakeholder_score" DataFormatString="{0:N2}" HtmlEncode="false" />
                                                            <asp:BoundField DataField="overall_score" HeaderText="Overall"
                                                                SortExpression="overall_score" DataFormatString="{0:N2}" HtmlEncode="false" />
                                                        </Columns>
