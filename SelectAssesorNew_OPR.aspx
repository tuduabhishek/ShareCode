<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SelectAssesorNew_OPR.aspx.vb" Inherits="SelectAssesorNew_OPR"
                        ...
                        <div class="container">
                            <div class="section-title">
                                <%-- <h3 style="font-size:24pt;">Feedback would be requested from four category of
                                    ...
                                    <%-- <h4> Accordingly, as a part of your own 360 survey, you are requested to select
                                        the appropriate category and verify the list of your peers ( minimum three
                                        required) and add your Stakeholders. The Manager and Subordinate lists have been
                                        pre populated for your convenience. The survey would be triggered to all the
                                        respondents in Manager, Subordinate and Peers categories and any five ( selected
                                        randomly) from the Internal Stakeholder category</h4>--%>
                            </div>
