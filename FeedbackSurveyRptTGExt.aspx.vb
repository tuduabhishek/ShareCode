...
Partial Class FeedbackSurveyRptTGExt
    ...
    Public Sub insertData(pno As String, yer As String, cyc As String, levl As String)
        Try
            ...
            If gt.Rows.Count <= 0 Then
                ...
                Dim qry As String = String.Empty
                If Session("ADM_USER") Is Nothing Then
                    qry = "insert into hrps.t_feedback360_rpt_overall (select AR.ss_year,AR.ss_srlno,AR.ema_perno,AR.ema_ename,'" & levl & "',AR.ss_categ,A,C,R,T,AC,COL,RES,TEAM,AC,COL,RES,TEAM,'" & pno.ToString & "',SYSDATE,null,null from hrps.v_all_i1_i6_t AR where AR.ema_perno=:ema_perno and AR.ss_categ='Z-OVERALL')"
                Else
                    qry = "insert into hrps.t_feedback360_rpt_overall (select AR.ss_year,AR.ss_srlno,AR.ema_perno,AR.ema_ename,'" & levl & "',AR.ss_categ,A,C,R,T,AC,COL,RES,TEAM,AC,COL,RES,TEAM,'" & Session("ADM_USER").ToString & "',SYSDATE,null,null from hrps.v_all_i1_i6_t AR where AR.ema_perno=:ema_perno and AR.ss_categ='Z-OVERALL')"
                End If
