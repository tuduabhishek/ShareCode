<%@ Page Title="" Language="VB" MasterPageFile="~/AdminMaster.master" AutoEventWireup="false" CodeFile="ReturnToAssesse.aspx.vb" Inherits="ReturnToAssesse" %>
            ...
            <div class="container-fluid">
                <div class="panel-body">
                    <div class="row form-group p-1">
                        ...
                        <div class="col-md-2 text-left">
                            <label class="font-weight-bold">Officer Per. No.<span class="text-danger">*</span></label>
                            <asp:TextBox runat="server" ID="txtperno" CssClass="form-control" MaxLength="6" placeholder="Officer Per. No."></asp:TextBox>
                        </div>
                        <div class="col-md-2 text-left">
                            <div style="margin-top:7px;">
                                <asp:LinkButton runat="server" ID="btnreset" Text="Return" class ="btn btn-warning btn-md mt-4 text-white" OnClick="btnreset_Click"  ></asp:LinkButton>
                            </div>                            
                        </div>
                    </div>
                </div>
