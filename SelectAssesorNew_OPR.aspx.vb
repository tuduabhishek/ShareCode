...
Partial Class SelectAssesorNew_OPR
  ...
  System.Web.Services.WebMethod()>
    Public Shared Function SearchPrefixesForApprover(ByVal prefixText As String, ByVal count As Integer) As List(Of String)
        Dim ob As New SelectAssesorNew_OPR
        Try
            ...
            cmd.CommandText += " :ema_ename)  and ema_disch_dt is null AND EMA_COMP_CODE='1000'and EMA_EMP_CLASS='2'  and EMA_EQV_LEVEL in('I3','I4','I5','I6')"
    ...
    Public Sub bindFinalGrid(pno As String)
        ...
        Try
            ...
            qry += "',SS_CATEG) categ,SS_CATEG ,SS_DEPT,SS_EMAIL from t_survey_status  where ss_asses_pno =:ss_asses_pno and ss_year=:ss_year and SS_SRLNO=:SS_SRLNO"
            ...
            cmd.Parameters.AddWithValue("SS_SRLNO", dtsrl.Rows(0).Item(0))
    ...
    Public Function ChkAuthlabel(pno As String) As String
        Try
            ...
            qry.CommandText = "select EMA_EQV_LEVEL from tips.t_empl_all  where ema_perno=:ema_perno and EMA_EQV_LEVEL in('I3','I4','I5','I6') and ema_disch_dt is null AND EMA_COMP_CODE='1000'"
    ...
    Public Function ChkValidation() As String
        ...
        Try
            ...
            Dim type1 As String = ChkAuthlabel(Right(txtperno.Text.Trim(), 7).TrimEnd(")"))
            If type1 = "" Then
                ShowGenericMessageModal(CommonConstants.AlertType.error, "Some issue Occurs..")
                Exit Function
            End If
            ...
            If dt.Rows.Count > 0 Then
                For i = 0 To dt.Rows.Count - 1
                    ...
                    cmdqry.Parameters.AddWithValue("SS_ASSES_PNO", Right(txtperno.Text.Trim(), 7).TrimEnd(")"))
                    ...
                    cmdqry.Parameters.AddWithValue("SS_SRLNO", dtsrl.Rows(0).Item(0))
    ...
    Protected Sub btnsubmit_Click(sender As Object, e As EventArgs)
        Try
            ...
            upqry = " update t_survey_status set SS_FLAG1 ='2',SS_TAG='SU',SS_APPROVER='" & Session("ADM_USER") & "',SS_WFL_STATUS='2',SS_ADM_UPD_DT=sysdate,SS_APP_TAG='AP',ss_tag_dt =sysdate, "
            upqry += " SS_UPDATED_BY='" & Session("ADM_USER").ToString() & "', SS_UPDATED_DT=sysdate where  SS_ASSES_PNO ='" & Right(txtperno.Text.Trim, 7).TrimEnd(")") & "' and ss_year='" & lblyear.Text & "' and ss_del_tag='N' and ss_status='SE' and nvl(SS_WFL_STATUS,'0') not in ('2','3','9') and  SS_SRLNO='" & dtsrl.Rows(0).Item(0) & "'"
    ...
    Protected Sub btnaddtslsub_Click(sender As Object, e As EventArgs)
        If txtperno.Text.Length > 6 Then
            ...
            strself.CommandText = "select SS_ASSES_PNO from t_survey_status  where  SS_ASSES_PNO='" & pno & "' and SS_CATEG='Self'  and SS_YEAR='" & lblyear.Text & "' and SS_SRLNO='" & dtsrl.Rows(0).Item(0) & "'"
    ...
    Protected Sub GvRepoties_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        Try
            ...
            qry += " and ss_pno='" & aspno & "' and ss_status='SE' and ss_del_tag='N' and ss_categ='" & cat.Text & "' and SS_SRLNO='" & dtsrl.Rows(0).Item(0) & "'"
    ...
    Public Function Check(year As String, assespno As String, pno As String) As String
        ...
        Try
            ...
            str.Parameters.AddWithValue("SS_SRLNO", dtsrl.Rows(0).Item(0))
    ...
    Public Function ChkValidationmaxstake() As String
        ...
        Try
            Dim cmdqry As New OracleCommand()
            Dim type As String = String.Empty
            Dim lvl As String = ChkAuthlabel(Right(txtperno.Text.Trim(), 7).TrimEnd(")"))
            If lvl = "" Then
                ShowGenericMessageModal(CommonConstants.AlertType.error, "Some isssue occurs....")
                Exit Function
            End If
    ...
    Public Sub SaveData(ByVal role As String, ByVal pno As String, ByVal name As String, ByVal desg As String, ByVal org As String, ByVal email As String, ByVal lvl As String, ByVal orgtype As String, assespno As String)
        ...
        Try
            ...
            Dim dtsrl As DataTable = getsrlno()
            Dim str As New OracleCommand()
            str.CommandText = " select * from t_survey_status where  SS_YEAR=:SS_YEAR and SS_ASSES_PNO=:SS_ASSES_PNO and (SS_PNO=:SS_PNO OR upper(ss_email)=:SS_PNO) and SS_SRLNO=:SS_SRLNO "
            ...
            OrgStr += " SS_DEL_TAG,SS_TYPE,ss_year,SS_ASSES_PNO,SS_LEVEL,SS_ADM_TAG,SS_APP_TAG,SS_APPROVER,SS_WFL_STATUS,SS_SRLNO) values ('" & role & "', '" & id & "','" & pno & "','" & name & "','" & Replace(desg, "'", "''") & "','" & Replace(org, "'", "''") & "','" & email & "','SE','N', "
            OrgStr += " '" & Session("ADM_USER").ToString() & "', sysdate,'N','" & orgtype & "','" & lblyear.Text & "','" & assespno & "','" & lvl & "','2','','','','" & dtsrl.Rows(0).Item(0) & "')"
    ...
    Public Sub UpdateData(id As String, tag As String, deltag As String, catg As String)
        Try
            ...
            comnd.Parameters.AddWithValue("SS_SRLNO", dtsrl.Rows(0).Item(0))
            comnd.ExecuteNonQuery()
        Catch ex As Exception
        Finally
            If conHrps.State = ConnectionState.Open Then
    ...
    Public Sub PopDroupdown()
        Try
            ...
            If lvl = "I4" Or lvl = "I5" Or lvl = "I6" Then
                qry = "select IRC_CODE,IRC_DESC from t_ir_codes where irc_type='360RL' and IRC_VALID_TAG='A' and IRC_CODE not in('SELF','ROPT','PEER') order by 2"
            End If
            If lvl = "I3" Then
                qry = "select IRC_CODE,IRC_DESC from t_ir_codes where irc_type='360RL' and IRC_VALID_TAG='A' and IRC_CODE not in('SELF','ROPT') order by 2"
            End If
    ...
    Private Sub SelectAssesorNew_OPR_Load(sender As Object, e As EventArgs) Handles Me.Load
