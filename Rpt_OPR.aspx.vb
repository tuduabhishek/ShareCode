...
Partial Class RPT_OPR
    ...
    Private Sub Rpt_OPR_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If f.Rows.Count > 0 Then
            ...
            Else
                Responsiveness(perno, yr, cycle)
                getaccountibility(perno, yr, cycle)
                Collaboration(perno, yr, cycle)
                TeamBuilding(perno, yr, cycle)
                displayOverall_Cyc1(perno, yr, cycle)
            End If
