var TableDatatablesEditable = function () {
    var e = function () {
        ...
        function t(e, t) {
            var n = e.fnGetData(t),
                a = $(">td", t);
            a[0].innerHTML = '<select class="form-control" value="' + n[0] + '"> ' +
                '<option>alex</option>' +
                '<option>Anubhav</option>' +
                '<option>gist124</option>' +
                '</select>',
        ...
        $("#sample_editable_1_new").click(function (e) {
            ...
            null !== r && r != o ? (e(l, r), t(l, o), r = o) : r == o && "Save" == this.innerHTML ? (n(l, r), r = null, getRowData(o)) : (t(l, o), r = o)
        });
